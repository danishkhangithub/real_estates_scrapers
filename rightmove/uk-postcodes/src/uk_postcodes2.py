...
class PostcodesMapper2(scrapy.Spider):
    # spider name
    ...
    def write_results(self):
        with open('postcodes2.json', 'w') as json_file:
            json_file.write(json.dumps(self.mapped, indent=2))
        

# run scrper
process = CrawlerProcess()
process.crawl(PostcodesMapper2)
process.start()

# write results
PostcodesMapper2.write_results(PostcodesMapper2)
